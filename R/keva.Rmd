...
cran_pacs <- c("tidyverse","writexl","fs","stringr","rlang","magrittr","stats","foreach", "doParallel", "parallel", "fs", "janitor", "stringr","lubridate","forcats", "purrr","multidplyr", "curl", "units", "readxl") #"rvest", "chromote","httr2", "forecast"
dev_pacs <- c() 
bioc_pacs <- c()
py_pacs <- c()
...
http_headers_to_columns <- function(headers) {headers |> sapply(headers_to_columns_single, simplify = F) |> list_rbind()}
