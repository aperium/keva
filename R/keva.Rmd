...
download_details <- download_paramaters |>
  filter((!file_exists) | (modification_time < lastTradingClose() + dhours(4)) | ((modification_time < lastTradingClose()) & (file_age > dminutes(120))) | (size <= fs_bytes("1K")))
...
td_data <- time_series(download_details$Symbol,"1day","raw", apikey = TWELVEDATA_API_KEY)
