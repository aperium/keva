...
path <- "Dropbox (Personal)/Projects/investing/historic data" |> fs::path_home()
...
famrx <- request("https://query1.finance.yahoo.com/v7/finance/download/FAMRX?period1=938179800&period2=1723135605&interval=1d&events=history&includeAdjustedClose=true") |>
  req_perform()

famrx$headers

curl::curl_download("https://query1.finance.yahoo.com/v7/finance/download/FAMRX?period1=938179800&period2=1723135605&interval=1d&events=history&includeAdjustedClose=true", destfile = path(path,"famrx.csv"))
