...
longPred <- predictPriceSummary(hist2, dyears(1), today() + ddays(1)) |>
  rename_with(~ paste0(.x,"_long",recycle0 = TRUE), is.numeric)

shortPred <- predictPriceSummary(hist2, ddays(1), today() + ddays(1)) |>
  rename_with(~ paste0(.x,"_short",recycle0 = TRUE), is.numeric)
